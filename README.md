...
describing the three packages, prepared for submission to the Journal of Open
Source Software.

## Citing

Citation metadata lives in [`CITATION.cff`](CITATION.cff), which GitHub renders
as a "Cite this repository" button. A Zenodo DOI is minted on the first
release; see [`GITHUB_SETUP.md`](GITHUB_SETUP.md) for the steps.

## Contributing

Bug reports, questions, and pull requests are welcome — see
[`CONTRIBUTING.md`](CONTRIBUTING.md). Reports that a statistic disagrees with an
established reference are especially useful.
