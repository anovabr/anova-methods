...
[**EXAMPLES.md**](EXAMPLES.md) documents every public function with a runnable
example on the bundled dataset. It is generated by executing each block, so the
printed output there is real rather than illustrative. Regenerate it with:
